...
export QRD_CACHE_ROOT="/var/scratch/valperga/robotics/quick_robot_draw/data"

# Root of QuickDraw faiss index.
export QRD_INDEX_ROOT="/var/scratch/valperga/robotics/quick_robot_draw/index"
...
export QRD_OUTPUT_PARENT_DIR="/var/scratch/valperga/robotics/quick_robot_draw/runs/outputs"

# Parent directory for checkpoints (each run uses a subdirectory named by wandb run id).
export QRD_CHECKPOINT_PARENT_DIR="/var/scratch/valperga/robotics/quick_robot_draw/runs/checkpoints"
...
export QRD_PROFILE_TRACE_DIR="/var/scratch/valperga/robotics/quick_robot_draw/runs/profiles"

# Distinct trace file names within the same profiling directory.
export QRD_PRETRAIN_PROFILE_TRACE_FILE="pretrain_trace.json"
export QRD_TTT_PROFILE_TRACE_FILE="ttt_trace.json"

# =============================================================================
# WANDB
# =============================================================================

export WANDB_PROJECT="qrd-perceiver-pretrain"
...
echo "[env.sh] QRD_TTT_PROFILE_TRACE_FILE=${QRD_TTT_PROFILE_TRACE_FILE}"
