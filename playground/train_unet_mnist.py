...
def build_dataloader(cfg: ConfigDict, train: bool = True) -> Tuple[torch.utils.data.Dataset, DataLoader, int]:
...
def train(cfg: ConfigDict) -> None:
    ...
    train_set, train_loader, channels = build_dataloader(cfg, train=True)
