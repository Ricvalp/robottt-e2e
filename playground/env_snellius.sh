...
export IMAGENET_TRAIN_DIR="/scratch-nvme/ml-datasets/imagenet/torchvision_ImageFolder/train"
export IMAGENET_VAL_DIR="/scratch-nvme/ml-datasets/imagenet/torchvision_ImageFolder/val"

# ImageNet nearest-neighbor cache root (embeddings + FAISS index)
# Change to scratch path on cluster if needed.
export IMAGENET_NN_CACHE_DIR="/projects/prjs1905/imagenet_nn"
...
export PLAYGROUND_CHECKPOINT_DIR="/projects/prjs1905/checkpoints"

# Base directory for outputs (samples, FID stats, etc.)
export PLAYGROUND_OUTPUT_DIR="/projects/prjs1905/outputs"
