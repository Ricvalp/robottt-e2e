...
def log_denoise(
    ...
    """Log noised images and predicted x0 for debugging."""
...
def adapt_and_sample(
    ...
    with torch.no_grad():
        ...
        cond_for_gen = cond_imgs[:1].repeat(img.shape[0], 1, 1, 1)
    ...
    for epoch in range(1, cfg.training.epochs + 1):
        ...
        if epoch % cfg.training.sample_every_epochs == 0:
            ...
            if wandb_run is not None:
                ...
                log_denoise(ddpm, imgs_all[0], cond_all[0], device, wandb_run, global_step)
