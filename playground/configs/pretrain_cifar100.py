...
def get_config():
    ...
    cfg.data.holdout_per_class = 50
    cfg.data.use_full_dataset = False
    cfg.data.leave_out_classes = [98, 99]
    ...
    cfg.sample.num_images_per_class = 4
    cfg.sample.num_classes_to_show = 8
    cfg.sample.steps = 100
    cfg.sample.use_eval_classes = False
    ...
    cfg.fid.use_eval_classes = False
    cfg.fid.dataset_key = "cifar100_cond_pretrain_full"
    cfg.fid.inception_dataset_key = "cifar100_cond_pretrain_full_inception"
    ...
    cfg.wandb.use = False
    cfg.wandb.project = "ddpm-cifar100-conditional-pretrain"
    ...
    cfg.checkpoint.dir = os.path.join(
        os.environ.get("PLAYGROUND_CHECKPOINT_DIR", "playground/checkpoints/cifar100/"),
