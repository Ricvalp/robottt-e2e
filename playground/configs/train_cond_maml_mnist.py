...
def get_config():
    ...
    cfg.sample.dir = os.path.join(os.environ.get("PLAYGROUND_OUTPUT_DIR", "."), "outputs_cond")

    cfg.checkpoint = ConfigDict()
    cfg.checkpoint.dir = os.path.join(os.environ.get("PLAYGROUND_CHECKPOINT_DIR", "checkpoints"), "cond_mnist")
