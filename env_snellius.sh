#!/bin/bash
# Environment variables for QuickRobotDraw perceiver pretraining.
...
export QRD_OUTPUT_PARENT_DIR="/projects/prjs1905/robotics/quick_robot_draw/runs/outputs"

# Parent directory for checkpoints (each run uses a subdirectory named by wandb run id).
export QRD_CHECKPOINT_PARENT_DIR="/projects/prjs1905/robotics/quick_robot_draw/runs/checkpoints"
...
export QRD_PROFILE_TRACE_DIR="/projects/prjs1905/robotics/quick_robot_draw/runs/profiles"
