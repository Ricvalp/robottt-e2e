...
def get_config():
    ...
    cfg.wandb.use = False
    cfg.wandb.project = "ddpm-maml-mnist-cond-jax"
    cfg.wandb.entity = None
    cfg.wandb.run_name = "ddpm-maml-mnist-cond-jax"
    ...
    cfg.sample.dir = "playground_jax/outputs_cond"

    cfg.checkpoint = ConfigDict()
    cfg.checkpoint.dir = "playground_jax/checkpoints_cond"
